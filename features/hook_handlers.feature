Feature: Hook handlers
  ...
  Scenario:
    Given a file named "hookfile..java" with:
      """
    ...
    When I run `dredd ./apiary.apib http://localhost:4567 --server="node server.js" --language="dredd-hooks-jvm" --hookfiles=./hookfile..java --loglevel=debug`
